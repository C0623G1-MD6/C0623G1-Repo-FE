    ...
    <>
      ...
      <div className="container">
        <div>
          ...
          <div className="collectionAll ly-containerall">
            <div
            ...
            <div className="overflow-handling">
              ...
              <div className="ly-news-container">
                ...
                <div className="ly-news-content">
                  Chất nỉ DRY cao cấp với khả năng co giãn tối đa; màu sắc đa
                  dạng, độc đáo, phù hợp với từng cá tính.
                </div>
              </div>
              <div className="ly-news-container">
                <div
                ...
                <div className="ly-news-content">
                  Thiết kế liên tục được cải tiến, phom dáng tinh tế, mang lại
                  cảm giác dễ chịu khi mặc.
                </div>
              </div>
              <div className="ly-news-container">
                <div
                ...
                <div className="ly-news-content">
                  Bộ sưu tập giới thiệu các thiết kế mang phong cách hiện đại,
              ...
              <div className="ly-news-container">
                ...
                <div className="ly-news-content">
                  Các chi tiết được đầu tư tỉ mỉ, khiến bạn luôn tự tin toả
                  sáng. 100% cotton mang lại cảm giác mềm mại, thoải mái và dễ
                  chịu khi mặc, giảm hiện tượng vón cục xơ vải và giữ được phom
                  dáng tối đa.
                </div>
              </div>
            </div>
