                    ...
                    <div className="product-list shadow-lg border border-light mx-3">
                        ...
                        <form onSubmit={handleSubmit(saveProduct)} className="create-product p-4">
                                ...
                                <div>
                                    <svg className="MuiBox-root css-olkjfu" viewBox="0 0 480 360"
                                        ...
                                        <path fill="#FFC107" fill-rule="nonzero"
                                              ...
                                              opacity="0.5" transform="rotate(34.64 268.35 153.887)"/>
                                        <path fill="#FFC107" fill-rule="nonzero"
                                              d="M249.191579 161.852111L265.339079 161.852111 265.339079 177.999611 249.191579 177.999611z"
                                              opacity="0.3" transform="rotate(34.64 257.265 169.926)"/>
                                        <path fill="#FFF" fill-rule="nonzero"
                                        ...
                                        <path fill="#FF4842" fill-rule="nonzero"
                                              ...
                                              opacity="0.5" transform="rotate(16.29 251.658 150.547)"/>
                                        <path fill="#FF4842" fill-rule="nonzero"
                                              d="M238.116192 161.182554L254.263692 161.182554 254.263692 177.330054 238.116192 177.330054z"
                                              opacity="0.3" transform="rotate(16.29 246.19 169.256)"/>
                                        <path fill="#FFF" fill-rule="nonzero"
                                        ...
                                        <path fill="#1890FF" fill-rule="nonzero"
                                              ...
                                              opacity="0.5" transform="rotate(4.6 242.308 150.487)"/>
                                        <path fill="#1890FF" fill-rule="nonzero"
                                              d="M232.672488 161.846499L248.819988 161.846499 248.819988 177.993999 232.672488 177.993999z"
                                              opacity="0.3" transform="rotate(4.6 240.746 169.92)"/>
                                        <path fill="#FFF" fill-rule="nonzero"
                                        ...
                                        <path fill="#00A76F" fill-rule="nonzero"
                                              ...
                                              opacity="0.5" transform="rotate(-2.862 236.39 151.563)"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                              d="M228.525282 163.608968L244.672782 163.608968 244.672782 179.756468 228.525282 179.756468z"
                                              opacity="0.3" transform="rotate(-2.61 236.599 171.683)"/>
                                        ...
                                        <ellipse cx="380.363" cy="298.487" fill="#00A76F" fill-rule="nonzero"
                                                 opacity="0.1" rx="8.945" ry="1.513"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                        ...
                                        <ellipse cx="390.052" cy="264.383" fill="#00A76F" fill-rule="nonzero"
                                                 opacity="0.1" rx="5.044" ry="1"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                        ...
                                        <ellipse cx="346.97" cy="270.022" fill="#00A76F" fill-rule="nonzero"
                                                 opacity="0.1" rx="6.09" ry="1.028"/>
                                        <rect width="51.026" height="91.312" x="303.926" y="69.211" fill="#FFF"
                                              fill-rule="nonzero" rx="4.737" transform="rotate(-71.99 329.44 114.867)"/>
                                        <circle cx="303.613" cy="103.507" r="9.376" fill="#00A76F" fill-rule="nonzero"
                                                opacity="0.2"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                              d="M344.582495 86.4883769L347.150665 86.4883769 347.150665 127.336977 344.582495 127.336977z"
                                              opacity="0.2" transform="rotate(-71.99 345.867 106.913)"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                              d="M333.028401 99.6373982L335.596571 99.6373982 335.596571 120.445898 333.028401 120.445898z"
                                              opacity="0.2" transform="rotate(-71.99 334.312 110.042)"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                              d="M337.109071 101.431004L339.677241 101.431004 339.677241 135.086304 337.109071 135.086304z"
                                              opacity="0.2" transform="rotate(-71.99 338.393 118.259)"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                              d="M338.505494 105.174377L341.073664 105.174377 341.073664 146.022978 338.505494 146.022978z"
                                              opacity="0.2" transform="rotate(-71.99 339.79 125.599)"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                              d="M348.060839 134.648161L353.026769 134.648161 353.026769 145.952261 348.060839 145.952261z"
                                              opacity="0.5" transform="rotate(-71.99 350.544 140.3)"/>
                                        <rect width="50.3" height="78.305" x="291.549" y="174.486" fill="#FFF"
                                              fill-rule="nonzero" rx="4" transform="rotate(-57.265 316.7 213.638)"/>
                                        ...
                                        <path fill="url(#linearGradient-2)" fill-rule="nonzero"
                                              d="M269.277 168.76l-45.767.493a3.127 3.127 0 00-3.094 3.125v3.782a3.127 3.127 0 01-3.05 3.124l-33.024.792a3.124 3.124 0 01-3.095-2.308l-1.551-5.701a3.124 3.124 0 00-3.053-2.308l-44.113.475a3.125 3.125 0 00-3.05 3.648l17.747 104.449a3.129 3.129 0 003.071 2.604l139.363.598a3.129 3.129 0 003.082-3.714l-20.366-106.521a3.125 3.125 0 00-3.1-2.538z"
                                              opacity="0.32"/>
                                        <ellipse cx="119.593" cy="258.664" fill="#00A76F" fill-rule="nonzero"
                                                 opacity="0.1" rx="4.846" ry="1"/>
                                        <ellipse cx="101.03" cy="260.545" fill="#00A76F" fill-rule="nonzero"
                                                 opacity="0.1" rx="4.846" ry="1"/>
                                        <ellipse cx="108.459" cy="265.905" fill="#00A76F" fill-rule="nonzero"
                                                 opacity="0.1" rx="3.444" ry="1"/>
                                        <ellipse cx="89.193" cy="265.433" fill="#00A76F" fill-rule="nonzero"
                                                 opacity="0.1" rx="3.444" ry="1"/>
                                        <path fill="#00A76F" fill-rule="nonzero"
                                        ...
                                        <path stroke="#004B50" stroke-linecap="round" stroke-width="0.5"
                                        ...
                                        <circle cx="84.467" cy="87.003" r="6.467" fill="#00A76F" fill-rule="nonzero"
                                                opacity="0.1"/>
                                        <circle cx="395.425" cy="138.681" r="6.467" fill="#00A76F" fill-rule="nonzero"
                                                opacity="0.1"/>
                                        <circle cx="279.178" cy="66.467" r="6.467" fill="#00A76F" fill-rule="nonzero"
                                                opacity="0.1"/>
                                        <circle cx="97.4" cy="122.68" r="10.838" fill="#00A76F" fill-rule="nonzero"
                                                opacity="0.1"/>
                                        <path fill="#007867" fill-rule="nonzero"
                                ...
                                <div className="col-lg-4">
                                    ...
                                    <div className="d-flex">
                                        <div className="form-check form-check-inline" id="gender">
                                            <input onInput={changeValue} className="form-check-input" id="male"
                                                   type="radio" value="0"
                                        ...
                                        <div className="form-check form-check-inline ms-3">
                                            <input onInput={changeValue} className="form-check-input " id="female"
                                                   type="radio" value="1"
                                                   name="gender" {...register("gender", validation.gender)}
                                                   data-sb-validations="required"/>
                                        ...
                                        {sizes.map((item) =>
                                            <div className="form-check me-4" key={item.id}>
                                                <input onInput={changeValue}
                                                       name="sizeId" {...register("sizeId", validation.sizeId)}
                            ...
                            <div className="row ">
                                ...
                                <div className="col-lg-4">
                                    <div className="cate-size">
                                        <div className="form-field">
                                            <input onInput={changeValue}
                                                   name="price" {...register("price", validation.price)} type="number"
                            ...
                            <div className="form-field mt-3">
                                <textarea onInput={changeValue}
                                          name="description" {...register("description", validation.description)} className="form-input" style={{width:"100%",height: "87px"}} rows="3" id="description" cols="20" placeholder=" "/>
                                <label htmlFor="name" className="form-label">Mô tả sản phẩm</label>
                            </div>
                            <div className="validation">
                                <p><small className='text-danger'>{errors?.description?.message}</small></p>
                                <p><small className='text-danger mt-0'>{beError?.description}</small></p>
                            </div>
